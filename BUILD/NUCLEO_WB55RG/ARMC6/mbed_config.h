...
#define CORDIO_RPA_SWAP_WORKAROUND                                              1                                                                                                // set by library:cordio[NUCLEO_WB55RG]
...
#define MBED_CONF_TARGET_I2C_TIMING_VALUE_ALGO                                  0                                                                                                // set by target:MCU_STM32WB
...
#define MBED_CONF_TARGET_LSE_DRIVE_LOAD_LEVEL                                   RCC_LSEDRIVE_LOW                                                                                 // set by target:MCU_STM32WB
